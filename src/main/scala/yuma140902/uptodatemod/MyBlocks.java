...
public final class MyBlocks {
	...
	static {
		...
		if(buttons.featureEnabled()) {
			add(buttonAcacia = 		new BlockGenericButton(McConst.Meta$.MODULE$.PLANK_ACACIA(), 	"button_acacia"));
			add(buttonBirch = 		new BlockGenericButton(McConst.Meta$.MODULE$.PLANK_BIRCH(), 		"button_birch"));
			add(buttonDarkOak = 	new BlockGenericButton(McConst.Meta$.MODULE$.PLANK_DARKOAK(), 	"button_dark_oak"));
			add(buttonJungle = 		new BlockGenericButton(McConst.Meta$.MODULE$.PLANK_JUNGLE(), 	"button_jungle"));
			add(buttonSpruce = 		new BlockGenericButton(McConst.Meta$.MODULE$.PLANK_SPRUCE(), 	"button_spruce"));
		}
		else {
			buttonAcacia = null;
			buttonBirch = null;
