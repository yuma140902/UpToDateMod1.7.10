...
public final class Recipes {
	...
	public static final ItemStack
		...
		PLANK_DARK_OAK = 	new ItemStack(Blocks.planks, 1, McConst.Meta$.MODULE$.PLANK_DARKOAK()),
	...
	private static void registerSlabRecipes() {
		...
		replaceRecipe(
			recipe -> {
				...
				return output.stackSize == 6 && output.getItemDamage() == McConst.Meta$.MODULE$.SLAB_SANDSTONE() && output.getItem() == Item.getItemFromBlock(Blocks.stone_slab);
			},
			() -> {
				RecipeRegister.addShaped(
						new ItemStack(Blocks.stone_slab, 6, 1),
						"###",
						'#', new ItemStack(Blocks.sandstone, 1, McConst.Meta$.MODULE$.SANDSTONE_NORMAL())
						);
		});
	}
