...
public class BlockFullWood extends Block implements IRegisterable, IHasRecipes {
	...
	private static final int[] metaToLogMeta = new int[] {	Meta.LOG_OAK, 	Meta.LOG_SPRUCE, 	Meta.LOG_BIRCH, 	Meta.LOG_JUNGLE, 	Meta.LOG2_ACACIA, 	Meta.LOG2_DARK_OAK};
	private static final int[] metaToPlankMeta = new int[] {	Meta.PLANK_OAK,	Meta.PLANK_SPRUCE, Meta.PLANK_BIRCH, Meta.PLANK_JUNGLE, Meta.PLANK_ACACIA, Meta.PLANK_DARKOAK};
