...
public final class MyBlocks {
	...
	public static final BlockGenericStrippedLog strippedLogAcacia = new BlockGenericStrippedLog("stripped_log_acacia", "stripped_acacia_log", Stat.PLANK_META_ACACIA);
	public static final BlockGenericStrippedLog strippedLogBirch = new BlockGenericStrippedLog("stripped_log_birch", "stripped_birch_log", Stat.PLANK_META_BIRCH);
	public static final BlockGenericStrippedLog strippedLogDarkOak = new BlockGenericStrippedLog("stripped_log_dark_oak", "stripped_dark_oak_log", Stat.PLANK_META_DARKOAK);
	public static final BlockGenericStrippedLog strippedLogJungle = new BlockGenericStrippedLog("stripped_log_jungle", "stripped_jungle_log", Stat.PLANK_META_JUNGLE);
	public static final BlockGenericStrippedLog strippedLogOak = new BlockGenericStrippedLog("stripped_log_oak", "stripped_oak_log", Stat.PLANK_META_OAK);
	public static final BlockGenericStrippedLog strippedLogSpruce = new BlockGenericStrippedLog("stripped_log_spruce", "stripped_spruce_log", Stat.PLANK_META_SPRUCE);
